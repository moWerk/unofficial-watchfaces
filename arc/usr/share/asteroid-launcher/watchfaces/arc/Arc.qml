...
Item {
    ...
    property var arcsData: function() {
        return [{
            "key": 'hours',
            "size": arcwidth * 0.5,
            "lineWidth": arcwidth * 0.12,
            "colorCircle": watchFace.arccolor,
            "opacity": 1
        }, {
            "key": 'minutes',
            "size": arcwidth * 0.75,
        ...
        Component {
            ...
            Item {
                ...
                property real arcEnd: {
                    ...
                    var type = data.key;
                    if (type === 'hours')
                        return ((timeBinding.getHours() % 12) * 30);
                ...
                // paint a pie instead of an arc
                property bool showBackground: false
                // a full circle as a background of the arc
